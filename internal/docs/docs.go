...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/git/add-patch": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Add patch request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.GitAddPatchRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/git/commit-diff": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Commit diff request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.GitCommitDiffRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/git/commit-files": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Commit files request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.GitCommitFilesRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.GitFetchRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.GitPullRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.GitPushRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/git/resolve-conflict": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Resolve conflict request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.GitResolveConflictRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/git/stash-drop": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Stash index request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.GitStashIndexRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.DeleteTerminalRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/terminal/delete-batch": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Terminal IDs",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.DeleteBatchRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handler.GitResolveConflictRequest": {
            "type": "object",
            "required": [
                "content",
                "filePath",
